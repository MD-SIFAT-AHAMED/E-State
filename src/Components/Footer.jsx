        ...
        <div className='pt-10 px-4 md:px-20 lg:px-32 bg-gray-900 w-full overflow-hidden' id='Footer'>
            <div className='container mx-auto flex flex-col md:flex-row justify-between items-start'>
                <div className='w-full md:w-1/3 mb-8 md:mb-0'>
                    ...
                    <p className='text-gray-400 mt-4'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Et non blanditiis velit, tempore laudantium vel, fugit omnis quos, inventore doloribus voluptas accusamus atque incidunt necessitatibus quis maiores sequi sint fugiat?</p>
                </div>
            ...
            <div className='border-t border-gray-700 py-4 mt-10 text-center text-gray-500'>
                Copyright © 2024 MD SIFAT AHAMED. All rights reserved.
            </div>
        </div>
    );
};
